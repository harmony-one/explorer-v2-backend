...
API serves REST/JSON and websocket. Also, here is initial draft for GRPC. Will be implemented fully on community demand. Current data can be viewed at [Harmony Block Explorer](https://explorer.harmony.one/).
